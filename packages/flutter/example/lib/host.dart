...
///
/// The palette is not fixed. A reader flips the site's own light and dark switch
/// whenever they like, and a query string carrying it would mean a new `src` on
/// every flip, which is a Flutter engine loaded again from nothing to change one
/// colour. So it does not ride in the URL: the page posts it into the frame, the
/// gallery listens, and the engine keeps running.
///
...
export 'package:lognal_example/host_none.dart'
    if (dart.library.js_interop) 'package:lognal_example/host_web.dart';
